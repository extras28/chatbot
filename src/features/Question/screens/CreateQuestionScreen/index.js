...
function CreateQuestionScreen(props) {
    ...
    //                         onChange={(e) => formik.getFieldHelpers("contentTextProblem").setValue(e)}
    //                         commands={[
    //                             commands.bold,
    //                             commands.italic,
    //                             commands.hr,
    ...
    //                                     const image = await Utils.uploadCloudinary(imgQuestion1);
    ...
    //                                 src={currentAccount.avatar || UserHelper.getRandomAvatarUrl()}
    //                                 onError={(e) => {
