...
import BaseTextArea from "general/components/Form/BaseTextArea";
                ...
                <div className="col-md-6 d-flex flex-column align-items-center align-items-md-start p-10">
                  <Fade left>
                    ...
                    <p className="mt-5 mt-md-10 lh-lg">
                      Một cộng đồng lớn mạnh với nhiều lập trình viên có kinh
                      nghiệm. Cung cấp các giải pháp tốt nhất cho vấn đề trong
                      mã nguồn của bạn.
                    </p>
                  ...
                  <div className="Screen3-percent d-flex flex-column mt-10">
                    ...
                    <Fade left delay={300}>
                      <div className="d-flex align-items-center p-3 mt-6">
                        ...
                        trong số các lập trình viên truy cập CodeHelper ít nhất
                        một lần một tuần
                      </div>
                    </Fade>
                  </div>
                ...
                <Fade bottom delay={200}>
                  <div className="w-100">
                    ...
                    <div className="SlideText1">
                      Trung bình CodeHelper nhận được hơn 100 triệu lượt truy
                ...
                <Fade bottom delay={300}>
                  <div className="w-100">
                    ...
                    <div className="SlideText2">
                      Hoa Kỳ, Ấn Độ, Anh, Đức, Canada, Pháp, Brazil, Nga, Úc và
                      Tây Ban Nha
                    </div>
                  </div>
                </Fade>
                ...
                <Zoom delay={400}>
                  <div className="BoxScreen9 d-flex flex-column bg-white align-items-center justify-content-between my-20 py-10 px-20">
                    ...
                    <p className="text-center" style={{ color: "#485763" }}>
                      Nơi các nhà phát triển và lập trình viên trao đổi kiến
                      thức
                    </p>
                    <NavLink
                      to="/sign-up"
