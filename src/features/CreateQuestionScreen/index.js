            ...
            <div className='bg-light'>
                <div className='create-question container pt-5'>
                    ...
                    <div className='help p-5 border border-primary'>
                        ...
                        <p className='fs-5'>
                            You’re ready to ask a programming-related question and this form will help guide you through
                    ...
                    <div className='Title p-5 mt-5 border border-2 border-secondary bg-white'>
                        ...
                        <p className='fs-6'>Be specific and imagine you’re asking a question to another person.</p>
                    ...
                    <div className='problem p-5 mt-5 border border-2 border-secondary bg-white'>
                        <p className='fs-5 fw-bold'>What are the details of your problem?</p>
                        <p className='fs-6'>
                    ...
                    <div className='problem p-5 mt-5 border border-2 border-secondary bg-white'>
                        <p className='fs-5 fw-bold'>What did you try and what were you expecting?</p>
                        <p className='fs-6'>
